...
export class ProfileController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new profile by predicting gender, age, and nationality from the given name via external APIs.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Profile already exists, returns the existing record.',
  })
  @ApiResponse({
    status: 400,
    description:
  ...
  @ApiOperation({
    ...
    description:
      'Returns all profiles with optional filters for gender, country, and age group.',
  })
  @ApiResponse({
    status: 200,
